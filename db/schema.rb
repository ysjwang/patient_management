...
ActiveRecord::Schema.define(version: 20131030194707) do
  ...
  add_index "appointments", ["email"], name: "index_appointments_on_email", unique: true, using: :btree
  add_index "appointments", ["next_appointment_id"], name: "index_appointments_on_next_appointment_id", using: :btree
  ...
  add_index "appointments", ["reset_password_token"], name: "index_appointments_on_reset_password_token", unique: true, using: :btree
